...
import StaffSetting from '../../components/softwareSetting/StaffSetting';
import GeneralSetting from '../../components/softwareSetting/GeneralSetting';
import KitchenSetting from '../../components/softwareSetting/KitchenSetting';
import DiscountSetting from '../../components/softwareSetting/DiscountSetting';
import TendorPayment from '../../components/softwareSetting/TendorPayment';
import Taxes from '../../components/softwareSetting/Taxes';
import Promotion from '../../components/softwareSetting/Promotion';
                                            ...
                                            <div className="input-group-append">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16.001" height="16" viewBox="0 0 16.001 16">
                                                    <g id="__TEMP__SVG__" opacity="0.45">
                                                        <path id="Path_12695" data-name="Path 12695" d="M23.13,23.128a1,1,0,0,1,1.415,0l3.85,3.85a1,1,0,1,1-1.414,1.415l-3.85-3.85a1,1,0,0,1,0-1.415Z" transform="translate(-12.688 -12.686)" fill="#1c2126" fillRule="evenodd"></path>
                                                        <path id="Path_12696" data-name="Path 12696" d="M6.5,12A5.5,5.5,0,1,0,1,6.5,5.5,5.5,0,0,0,6.5,12ZM13,6.5A6.5,6.5,0,1,1,6.5,0,6.5,6.5,0,0,1,13,6.5Z" transform="translate(0 0)" fill="#1c2126" fillRule="evenodd"></path>
                                                    </g>
                                                </svg>
                                            </div>
                                        </div>
                                ...
                                <div className="row auto-log">
                                    <div className="col-md-4">
                                        ...
                                        >
                                            {/* Nav Links */}
                                            <a
                                                className={`nav-link ${activeTab === 'v-pills-home-tab' ? 'active' : ''}`}
                                                id="v-pills-home-tab"
                                            ...
                                            <a
                                                className={`nav-link ${activeTab === 'v-pills-profile-tab' ? 'active' : ''}`}
                                            ...
                                            <a
                                                className={`nav-link ${activeTab === 'v-pills-messages-tab' ? 'active' : ''}`}
                                            ...
                                            <a
                                                className={`nav-link ${activeTab === 'v-pills-discount-tab' ? 'active' : ''}`}
                                            ...
                                            <a
                                                className={`nav-link ${activeTab === 'v-pills-tendor-tab' ? 'active' : ''}`}
                                            ...
                                            <a
                                                className={`nav-link ${activeTab === 'v-pills-taxes-tab' ? 'active' : ''}`}
                                            ...
                                            <a
                                                className={`nav-link ${activeTab === 'v-pills-promotion-tab' ? 'active' : ''}`}
                                    ...
                                    <div className="col-md-8">
                                        <div className="tab-content" id="v-pills-tabContent">
                                            ...
                                            {activeTab === 'v-pills-profile-tab' && <GeneralSetting />}
                                            {activeTab === 'v-pills-messages-tab' && <KitchenSetting />}
                                            {activeTab === 'v-pills-discount-tab' && <DiscountSetting />}
