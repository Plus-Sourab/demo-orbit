...
const Sidebar: React.FC<SidebarProps> = ({ isOpen }) => {
  ...
  const NavbarToggle = () => {
    const submenu = document.getElementById('Peripherals_SubMenu');
    if (submenu) submenu.classList.toggle('collapse');
  }
  ...
  return (
    <div
      ...
      style={{ width: isOpen ? "250px" : "0" }} // Example width change for sliding effect
    >
      <div className="page-body-wrapper">
        ...
        >
          ...
          <ul className="nav">
            ...
            >
              <Link className="nav-link px-0" to="/manage-profile">
            ...
            <li
              ...
              className="nav-item nav-item-commonClass_RestaurantLayout active"
            >
            ...
            <li
              ...
              className="nav-item nav-item-commonClass_RestaurantLayout"
            >
              <Link to="/manage-reports" className="nav-link px-0">
                <div className="nav-box">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="12.423"
            ...
            <li
              ...
              className="nav-item nav-item-commonClass_RestaurantLayout"
            >
              <Link to="/manage-products" className="nav-link px-0" >
                <div className="nav-box">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="18.998"
            ...
            <li
              ...
              className="nav-item nav-item-commonClass_RestaurantLayout"
            >
              <Link to="/menu-setup" className="nav-link px-0">
                <div className="nav-box">
                  <svg
                    width="22px"
                    height="22px"
            ...
            <li
              ...
              className="nav-item nav-item-commonClass_RestaurantLayout"
            >
              <Link to='/software-setting' className="nav-link px-0">
                <div className="nav-box">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="18.083"
            ...
            <li className="nav-item nav-item-commonClass_RestaurantLayout">
              <a
                className="nav-link"
              ...
              >
                ...
                >
                  <Link to="/table-Qr" className="nav-link px-0">
                    <div className="nav-box sub_menu_peripherals">
                      <svg
                        width="22px"
                        height="22px"
                ...
                >
                  <Link to="/store-Qr" className="nav-link px-0">
                    <div className="nav-box sub_menu_peripherals">
                      <svg
                        width="22px"
                        height="22px"
                ...
                >
                  <Link to="/stripe-setup" className="nav-link px-0">
                    <div className="nav-box sub_menu_peripherals">
                      <svg
                        width="22px"
                        height="22px"
                ...
                >
                  <Link to="/manage-orders" className="nav-link px-0">
                    <div className="nav-box sub_menu_peripherals">
                      <svg
                        width="22px"
                        height="22px"
            ...
            <li
              ...
              className="nav-item nav-item-commonClass_RestaurantLayout"
            >
              <Link to="/manage-reasons" className="nav-link px-0">
                <div className="nav-box sub_menu_peripherals">
                  <svg
                    version="1.0"
                    xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="footer-ul">
            ...
            <div className="fo-icon">
              ...
              <a href="javascript:;" className="icon-1">
                <svg
                  height="200px"
                  width="200px"
                  version="1.1"
