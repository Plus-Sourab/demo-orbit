                        ...
                        <label className="form-check-label flex-grow-1">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50">
                                <g id="Group_15081" data-name="Group 15081" transform="translate(14749 -14701)">
                                    ...
                                    <a data-toggle="modal" data-target="#promoCodeTableModal" id="btn_OpenPromoCodeTable_Modal_ManageSoftwareSetting" style={{ cursor: "pointer", textDecoration: "none", color: "#000" }}>Promocode</a>
