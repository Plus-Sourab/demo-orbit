                ...
                <div className="row align-items-center bg-light select-icon marg-box">
                    ...
                    <div className="col-6 col-md-4 col-lg-3">
                        <div className="form-group text_wrap-datepicker mb-0">
                            <label className="mb-0" style={{ width: 'auto', marginRight: '8px' }}>From</label>
                            <input
                                type="text"
                        ...
                        <div id="fromDate_error_CustomDatesSelectionViewRecord_ManageReports" className="errorsClass2"></div>
                    </div>

                    <div className="col-12 col-md-4 col-lg-3 date-pick-col">
                        <div className="form-group text_wrap-datepicker mb-0">
                            <label className="mb-0" style={{ width: 'auto', marginRight: '8px' }}>To</label>
                            <input
                                type="text"
                                className="form-control datetimepickerClass datetimepicker-input bg-light mt-0"
                        ...
                        <div id="toDate_error_CustomDatesSelectionViewRecord_ManageReports" className="errorsClass2"></div>
                    </div>
