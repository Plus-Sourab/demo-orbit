...
const ProductQuantityBarChart: React.FC = () => {
  ...
  const [productFilter, setProductFilter] = useState<ProductFilter>('quantity'); // default filter
      ...
      <div className="wraps_dashbords graph_wrapsproduts" style={{ padding: '12px' }}>
        ...
        <div className="wrap_dropsdowns" id="productCard2_graphfilter" style={{ zIndex: 4 }}>
          <Dropdown style={{ marginBottom: '10px' }}>
            ...
            <Dropdown.Menu>
              {(['Yearly', 'Monthly', 'Weekly', 'Daily'] as TimePeriod[]).map((period) => (
                <Dropdown.Item
                  key={period}
          ...
          <div className="p-0" style={{ height: '26px', marginTop: '10px' }}>
            <div className="wrap_dropsdownq">
              <Dropdown>
                ...
                <Dropdown.Menu>
                  {(['quantity', 'amount', 'profit'] as ProductFilter[]).map((filter) => (
                    <Dropdown.Item
                      key={filter}
